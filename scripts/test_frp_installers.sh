...
assert_contains_text "$source_dry_run" "name = \"machine-ssh-xtcp\""
assert_contains_text "$source_dry_run" "name = \"machine-ssh-stcp\""
assert_contains_text "$source_dry_run" "localPort = 8929"
assert_contains_text "$source_dry_run" "localPort = 2222"
assert_contains_text "$source_dry_run" "localPort = 22"
...
assert_contains_text "$client_dry_run" "serverName = \"machine-ssh-xtcp\""
assert_contains_text "$client_dry_run" "bindPort = 10022"
assert_contains_text "$client_dry_run" "fallbackTo = \"machine-ssh-stcp-visitor\""
